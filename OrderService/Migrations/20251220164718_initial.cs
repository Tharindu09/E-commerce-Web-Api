        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipLine2 = table.Column<string>(type: "text", nullable: false),
                    ShipCity = table.Column<string>(type: "text", nullable: false),
                    ShipDistrict = table.Column<string>(type: "text", nullable: false),
                    ShipProvince = table.Column<string>(type: "text", nullable: false),
